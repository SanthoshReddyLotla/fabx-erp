...
$routes = [
    ...
    'qms/ncr/print' => ['module' => 'qms', 'controller' => 'QMSController', 'action' => 'printNCR', 'auth' => true],
    ...
    'crm/quotations/print' => ['module' => 'crm', 'controller' => 'CRMController', 'action' => 'printQuotation', 'auth' => true],
    ...
    'purchase/orders/print' => ['module' => 'purchase', 'controller' => 'PurchaseController', 'action' => 'printOrder', 'auth' => true],
    ...
    'accounts/payments/print' => ['module' => 'accounts', 'controller' => 'AccountsController', 'action' => 'printReceipt', 'auth' => true],
